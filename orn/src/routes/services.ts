...
const sampleServices = [
  {
    ...
    description:
      "Kaliteli SUP board'larını saatlik olarak kiralayın. Tüm seviyeler için uygun.",
  ...
  },
  {
    ...
    description:
      'Profesyonel rehber eşliğinde unutulmaz SUP tur deneyimi yaşayın.',
  ...
  },
  {
    ...
    slug: 'sup-egitimi',
    description:
      'Başlangıçtan ileri seviyeye SUP eğitimi alın. Sertifikalı eğitmenlerle.',
