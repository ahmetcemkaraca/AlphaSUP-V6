...
// Set global options - Cost optimized for free tier
setGlobalOptions({
  region: 'us-central1',
  timeoutSeconds: 60, // Reduced from 300s for cost optimization
  memory: '256MiB', // Sufficient for scheduled tasks
});
...
export const sendBookingReminders = onSchedule(
  {
    schedule: 'every 4 hours', // Reduced frequency for cost optimization
    timeZone: 'Europe/Istanbul',
  },
  async _event => {
    console.log(
      '🚧 [Scheduled SMS] Rezervasyon hatırlatma kontrolü - Phase 7 Implementation'
    );
...
export const sendWeatherAlerts = onSchedule(
  ...
  async _event => {
    console.log(
      '🚧 [Scheduled SMS] Hava durumu uyarı kontrolü - Phase 7 Implementation'
    );
 ...
 */
export const sendArrivalInstructions = onSchedule(
  {
    schedule: 'every 2 hours', // Reduced from 30 minutes for cost optimization
    timeZone: 'Europe/Istanbul',
  },
  async _event => {
    console.log(
      '🚧 [Scheduled SMS] Varış talimatları kontrolü - Phase 7 Implementation'
    );
 ...
 */
export const aggregateSMSAnalytics = onSchedule(
  {
  ...
  async _event => {
    console.log(
      '🚧 [Scheduled SMS] SMS istatistik toplama - Phase 7 Implementation'
    );
 ...
 */
export const retrySMSMessages = onSchedule(
  {
    schedule: 'every 1 hours', // Reduced from 15 minutes for cost optimization
    timeZone: 'Europe/Istanbul',
  },
  async _event => {
    console.log(
      '🚧 [Scheduled SMS] Başarısız SMS yeniden deneme - Phase 7 Implementation'
    );
